"""
Bathymetry Super-resolution of CelebA using SR-ResNet.
The dataset can be downloaded from: https://drive.google.com/drive/folders/1Z7HR9uU2FCUijmoowKjZEoM44fbFzRhQ
Instrustion on running the script:
1. Download the dataset from the provided link
2. Unzip and save the folder 'train' and 'test' under 'img_align_celeba' to '../../data2/'
...
# Parameters
exp_name = "pretrain_on_interpolation" # Experiment name used to save loss plot
...
#model_pt = "./saved_models/generator_139.pth"
...
for epoch in range(epoch, n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        if (batches_done+1) % sample_interval == 0:
            ...
            if False:
                ...
                with rasterio.Env():
                    with rasterio.open(input_path[0]) as src: 
                        ...
                        #print(profile)
                    with rasterio.open("images_exp1/{}_{}.tif".format(hr_name,batches_done), 'w', **profile) as dst:
            ...
            save_image(img_grid, "images_exp1/%d.png" % batches_done, normalize=False) 
    ...
    if checkpoint_interval != -1 and (epoch+1) % checkpoint_interval == 0:
        ...
        torch.save(generator.state_dict(), "saved_models_exp1/generator_%d.pth" % epoch)
...
np.save('Loss_exp1/{}.npy'.format(exp_name),Gloss)
