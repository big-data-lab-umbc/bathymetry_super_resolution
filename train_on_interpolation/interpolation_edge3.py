...
# Parameters
exp_name = "train_on_interpolation_edge_4" # Experiment name used to save loss plot
...
for epoch in range(epoch, n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        sys.stdout.write(
            ...
            % (epoch+1, n_epochs, i+1, len(dataloader), loss_G.item(), loss_edge.item())
        )
