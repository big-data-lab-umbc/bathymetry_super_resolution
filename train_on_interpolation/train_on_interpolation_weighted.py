...
# Parameters
exp_name = "train_on_interpolation_weighted" # Experiment name used to save loss plot
...
for epoch in range(epoch, n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        loss_G = weighted_content + loss_content
        ...
        if (batches_done+1) % sample_interval == 0:
            ...
            save_image(img_grid, "images/noscale6/%d.png" % batches_done, normalize=False) 
    ...
    if checkpoint_interval != -1 and (epoch+1) % checkpoint_interval == 0:
        ...
        torch.save(generator.state_dict(), "saved_models/noscale6/generator_%d.pth" % epoch)
